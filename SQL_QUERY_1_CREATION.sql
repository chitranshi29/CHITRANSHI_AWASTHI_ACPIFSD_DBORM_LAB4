/* 2)Insert the data in the table created AS mentioned in readme file 	 */
/* Insert the DATA IN SUPPLIER TABLE  */
...
/* DISPLAY ALL the DATA IN SUPPLIER TABLE  */
/* Insert the DATA IN SUPPLIER TABLE  */
...
/*select * from ecommerce_dbms.Customer;
 DISPLAY ALL the DATA IN Customer TABLE  */
...
/*select * from ecommerce_dbms.Category;
 DISPLAY ALLthe DATA IN Category TABLE  */
...
/*select * from ecommerce_dbms.Product;
 DISPLAY ALL the DATA IN Product TABLE  */
...
/*select * from ecommerce_dbms.Supplier_pricing;
 DISPLAY ALL the DATA IN Supplier_pricing TABLE  */
/* Insert the DATA IN Supplier_pricing TABLE  */
...
/*select * from ecommerce_dbms.`ORDER`;
 DISPLAY ALL the DATA IN ORDER TABLE  */
...
/*select * from ecommerce_dbms.Rating;
 DISPLAY ALL the DATA IN Rating TABLE  */